...
public class RegistrationWithRandomUtilsTests extends TestBase {
    ...
    void fillFormTests() {
        ...
        registrationPage
                ...
                .setDateOfBirth(testData.calendarDay, testData.calendarYear, testData.month)
        ...
        results.
                ...
                .checkResult("Date of Birth", testData.calendarDay + testData.calendarYear + testData.month)
